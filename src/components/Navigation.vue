<template>
  <div class="navigation fk__navigation" :class="{ 'fk__navigation--dark': darkMenu, 'fk__navigation--fixed': fixedMenu}">
    ...
    <nav class="fk__navigation__nav" @click="toggleMenu" :class="{ 'fk__navigation__nav--open': isOpen }">
      <div class="fk__navigation__nav--first">{{pageName}}</div>
...
export default {
  ...
  mounted(){
    this.toggleMenuStyle(this.$route.path);
  },
  watch: {
    '$route': function(newRoute, oldRoute){
      this.toggleMenuStyle(newRoute.path);
    }
  },
  methods: {
    toggleMenu(){
      ...
      &__nav{
        ...
        ul{
          ...
          li, li a:link, li a:visited, li a:active{
            ...
            border-bottom: solid 1px transparentize($regent-gray, 0.5);
